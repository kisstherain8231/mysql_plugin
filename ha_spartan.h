...
/** @file ha_spartan.h
    ...
    @brief
  The ha_spartan engine is a stubbed storage engine for example purposes only;
  it does nothing at this point. Its purpose is to provide a source
  code illustration of how to begin writing new storage engines; see also
  /storage/example/ha_spartan.cc.
  ...
  handler.h.
   ...
   @see
  /sql/handler.h and /storage/example/ha_spartan.cc
*/
